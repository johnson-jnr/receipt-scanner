        ...
        const expenseSeeds = [
            {
                expense: {
                    ...
                    total: 8.70,
                    category: 'Dining',
                    receiptImagePath: 'dummy-receipts/aroma-cafe.png',
                    date: '2026-04-03',
                    time: '08:26',
                },
                items: [
            ...
            },
            {
                expense: {
                    ...
                    total: 67.43,
                    category: 'Groceries',
                    receiptImagePath: 'dummy-receipts/whole-foods.png',
                    date: '2026-04-07',
                    time: '17:14',
                },
                items: [
            ...
            },
            {
                expense: {
                    ...
                    total: 54.20,
                    category: 'Transport',
                    receiptImagePath: 'dummy-receipts/shell.png',
                    date: '2026-04-10',
                    time: '09:05',
                },
                items: [
            ...
            },
            {
                expense: {
                    ...
                    total: 89.97,
                    category: 'Shopping',
                    receiptImagePath: 'dummy-receipts/h&m.png',
                    date: '2026-04-15',
                    time: '14:33',
                },
                items: [
            ...
            },
            {
                expense: {
                    ...
                    total: 31.86,
                    category: 'Healthcare',
                    receiptImagePath: 'dummy-receipts/cvs.png',
                    date: '2026-04-21',
                    time: '11:47',
                },
                items: [
            ...
            },
            {
                expense: {
                    ...
                    total: 28.45,
                    category: 'Dining',
                    receiptImagePath: 'dummy-receipts/shake-shack.png',
                    date: '2026-04-28',
                    time: '13:10',
                },
                items: [
